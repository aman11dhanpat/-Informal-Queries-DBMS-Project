        ...
        <center>
        	<div style="margin-top:100px;width:300px;">
        		<?php if (isset($message)) 
        			...
        			echo "Please wait while you are being redirected to your destination.";
        		?>
        		<br /><a href="<?php echo $url; ?>">Click Here</a> if not redirected in 5 seconds.
        	</div>
        	<p><canvas width="27" height="27" id="myCanvas"></canvas></p>
        </center>
    </body>
</html>
