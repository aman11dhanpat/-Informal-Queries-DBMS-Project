...
<h2 style="font: normal 20px/23px Arial, Helvetica, sans-serif; margin: 0; padding: 0 0 18px; color: black;">Welcome <?php echo $name; ?>!</h2>
...
<br />
<br />
<?php if (strlen($user) > 0) { ?>Your username: <?php echo $user; ?><br /><?php } ?>
Your Password: <?php echo $pass; ?><br />
